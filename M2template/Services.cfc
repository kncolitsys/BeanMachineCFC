<!---
	COMPONENT: <beanname> Services
	AUTHOR: <author>
	DATE: <beandate>
	PURPOSE: <beanname> utility methods
	CHANGE HISTORY:
--->
<cfcomponent displayname="<beanname> Services" hint="I am a service of the <beanname>">

	<cffunction name="init" access="public" returntype="<beanname>Services" output="false" displayname="<beanname> Services Constructor" hint="I initialize the <beanname> Services.">
